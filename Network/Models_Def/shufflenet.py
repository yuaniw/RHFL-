...
class ShuffleNetV1(nn.Cell):
    ...
    ShuffleNetV1
    """
    def __init__(self, num_classes=10, model_size='1.0x', group=3):
...
def shufflenet(num_classes: int = 10, group: int = 3):
    return ShuffleNetV1(num_classes=num_classes, group=group)
